...
class MVTecDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if y == 0 or not self.hasGt:#good or not has gt
    ...
    def load_dataset_folder(self):
        ...
        hasGt = True if os.path.exists(gt_dir) else False
        self.hasGt = hasGt
        ...
        for img_type in img_types:
            ...
            if img_type == 'good':
                ...
                if hasGt:
                    ...
                    img_fname_list = [os.path.basename(f) for f in img_fpath_list]
                    gt_fpath_list = [os.path.join(gt_type_dir, img_fname)
