...
print("dist.size()="+str(dist.size()))
print("dist.rank()="+str(dist.rank()))
...
#(mnist_images, mnist_labels), _ = tf.keras.datasets.mnist.load_data(path="mnist-%d.npz" % dist.rank())
(mnist_images, mnist_labels), _ = tf.keras.datasets.mnist.load_data(path="/opt/ml/input/data/training/mnist.npz")
